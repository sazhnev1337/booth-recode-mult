#!/usr/bin/env python3
"""
Stimulus generator for 8-bit multipliers.

Usage:
    gen_stimulus_8.py <distribution> <update_period> <recoding_mode> <output_path> [N]

Examples:
    gen_stimulus_8.py uniform 1  standard ../sim/data/stim8_uniform_fast_standard.txt 20000
    gen_stimulus_8.py gauss  10  approx_2 ../sim/data/stim8_gauss_slow_approx_2.txt
"""
