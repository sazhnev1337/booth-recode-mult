...
module tb_mult_booth_extrec_8;
    ...
    initial begin
        ...
        $dumpvars(0, tb_mult_booth_extrec_8);

        rst_n = 0; a_recoded = 12'b0; b = 8'sd0;
        #20; rst_n = 1;

        if (!$value$plusargs("STIM=%s", stimulus_path))
            stimulus_path = "data/stim8_uniform_fast_exact.txt";
